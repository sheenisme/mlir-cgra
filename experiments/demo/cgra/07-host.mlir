...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", soda.container_module} {
  func.func private @cgra_fusion_add_max_add_0(memref<16x16xf32, #map0>, memref<16x16xf32, #map0>, memref<16x16xf32, #map0>, memref<16x16xf32, #map0>)
  ...
  func.func @main_graph(%arg0: memref<16x32xf32>, %arg1: memref<32x16xf32>, %arg2: memref<16x16xf32>, %arg3: memref<16x16xf32>, %arg4: memref<16x16xf32>) attributes {input_names = ["X0", "X1", "X2", "X3"], output_names = ["Z0"]} {
    ...
    scf.for %arg5 = %c0 to %c16 step %c16 {
      scf.for %arg6 = %c0 to %c16 step %c16 {
        %3 = memref.subview %1[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map0>
        %4 = memref.subview %arg2[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map0>
        %5 = memref.subview %arg3[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map0>
        %6 = memref.subview %2[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map0>
        func.call @cgra_fusion_add_max_add_0(%3, %4, %5, %6) : (memref<16x16xf32, #map0>, memref<16x16xf32, #map0>, memref<16x16xf32, #map0>, memref<16x16xf32, #map0>) -> ()
      }
    }
