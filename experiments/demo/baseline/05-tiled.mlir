    ...
    scf.for %arg5 = %c0 to %c16 step %c4 {
      scf.for %arg6 = %c0 to %c16 step %c4 {
        scf.for %arg7 = %c0 to %c32 step %c16 {
          ...
          linalg.matmul {__internal_linalg_transform__ = "offloadedOnCGRA"} ins(%3, %4 : memref<4x16xf32, #map0>, memref<16x4xf32, #map1>) outs(%5 : memref<4x4xf32, #map1>)
        }
      }
    }
    %2 = memref.alloc() {alignment = 128 : i64} : memref<16x16xf32>
    scf.for %arg5 = %c0 to %c16 step %c16 {
      scf.for %arg6 = %c0 to %c16 step %c16 {
        %3 = memref.subview %1[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map1>
        %4 = memref.subview %arg2[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map1>
        %5 = memref.subview %arg3[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map1>
        %6 = memref.subview %2[%arg5, %arg6] [16, 16] [1, 1] : memref<16x16xf32> to memref<16x16xf32, #map1>
        linalg.generic {indexing_maps = [#map2, #map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%3, %4, %5 : memref<16x16xf32, #map1>, memref<16x16xf32, #map1>, memref<16x16xf32, #map1>) outs(%6 : memref<16x16xf32, #map1>) attrs =  {__internal_linalg_transform__ = "offloadedOnCGRA"} {
